...
1. Open **Bitcoin Knots (BLAKE2b) Companion**.
2. Make sure it is **running**.
3. Go to **Actions** and run **Get Payout Address**.
4. Copy the address it shows you. It starts with `bc1`.

That address belongs to a wallet on your node. Back the node up, or use an address
from a wallet you already back up, such as Sparrow.
